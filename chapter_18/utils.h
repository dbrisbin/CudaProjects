...
inline __host__ __device__ int LinearizeIndex(const int x, const int y, const int X)
{
    return y * X + x;
}
...
inline __host__ __device__ int LinearizeIndex(const int x, const int y, const int z, const int X,
                                              const int Y)
{
    return z * X * Y + y * X + x;
}
